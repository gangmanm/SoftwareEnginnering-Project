...
public class MyCommentAdapter extends RecyclerView.Adapter<MyCommentAdapter.MyViewHolder> {
    ...
    public MyCommentAdapter(Context context, ArrayList<com.example.commento.NewComment> newCommentArrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        com.example.commento.NewComment newComment = newCommentArrayList.get(position);



        holder.comment.setText(newComment.getComment());
        holder.uid.setText(newComment.getUid());
        holder.highlight.setText(newComment.getHighlight());
        ...
        String highlight ="";
        for(int i=0; i<newCommentArrayList.size(); i++)
        {
            highlight +=newCommentArrayList.get(i).getHighlight()+"#";

        }
        System.out.println("Print this" + highlight);
        if(highlight != null) {
            Post_Detail.highlight_list = highlight;
        }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            highlight = itemView.findViewById(R.id.highlight_card);
        }
